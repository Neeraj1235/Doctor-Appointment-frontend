  ...
  return (
    <div className="signup__bg">
      <Container className="p-5 pb-3 pt-0 signup__container d-flex align-items-center justify-content-around">
        <Row className="w-100">
          <Col
            className="text-primary h1  border-end me-2 pb-3 d-flex align-items-center justify-content-center signup__border"
            md={6}
          >
            <h1>
          ...
          {!isuserSelected && (
            <Col>
              <h4 className="text-center pb-2 text-secondary fw-dark fs-2">
              ...
              <div className="d-grid gap-2 col-6 mx-auto mt-4 ">
                <Button
                  ...
                  type="submit"
                  onClick={patientUserBtnHandler}
                >
                  I am a Patient
                </Button>
              </div>
              <p className="text-center pt-3 text-secondary fw-dark fw-bolder fs-2">
                or
              </p>
              <div className="d-grid gap-2 col-6 mx-auto mt-4">
                <Button
